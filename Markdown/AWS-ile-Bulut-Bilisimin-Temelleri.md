...
<center> <h1>ÖNSÖZ</h1> </center>

Bulut bilişim bilgi işlem hizmetlerinin (sunucu, depolama, veri
tabanı, ağ, yazılım, analiz ve makine zekâsı dahil) internet üzerinden sağlanarak daha hızlı
...
<p align="right"><b>Fatih Es</p>

<p align="right">Bursa 2022</b></p>
...
10:** AWS region (bölgelerin) dünyada konumlanması*
...
olduğundan yönetilmesi gereken bir
...
Amazon CloudSearch, AWS Cloud\'da web
...
Özelleştirilmiş Amazon EC2 kümeleri,
...
Amazon FinSpace, finansal hizmetler
...
Amazon Kinesis gerçek zamanlı akış
...
Yüksek oranda erişilebilir Apache Kafka
...
çalıştırma imkânı sunar. İhtiyacınız
...
Herkes için kolay analizlerle verilerden
...
AWS Data Exchange, bulutta üçüncü taraf
...
AWS Data Pipeline, verilerinizi belirli
...
AWS Glue; analiz, makine öğrenimi ve
...
AWS Lake Formation, günler içinde güvenli
...
dönüştürür. Amazon Sumerian hizmeti artık
...
Verileri, otomatik ağ eşleme ve akıllı
...
adı sistemi (DNS) web hizmetidir.
...
Bağlantıları koruma altına almanızı ve
...
iletişimi sağlayan bir hizmet ağıdır. App
...
güvenliği artırabilir. Tüm ağınızı tek
...
AWS\'ye doğrudan bağlanarak ve genel
...
AWS Global Accelerator, Amazon Web
...
Özel bir 5G ağının düşük gecikme süresi
...
AWS PrivateLink, farklı hesaplar ve
...
karmaşık eşleme ilişkilerini sonlandırır.
...
AWS VPN iki hizmetten oluşur: AWS Siteden
...
imkân sunar. Bütünleşmiş sertifika
...
Amazon Managed Blockchain, genel ağlara
...
Yerleşik kriptografik doğrulama, veri
...
İşletmeler ve kuruluşlar, bulut
...
"Savings Plans" hakkındaki ek meta
...
görselleştirmenize, anlamanıza ve
...
sunucuları için özel kullanım ve kapsam
...
Savings Plans, bir veya üç yıllık bir
...
Görüntüleri otomatik şifreleme ve erişim
...
Denetim düzlemini, düğümleri ve bulut
...
yapılandırmanın birden fazla yolunu
...
AWS Copilot, müşterilerin AWS\'de
...
Altyapıyı değil, uygulamalarınızı dağıtıp
...
bütünleşmiş bir deneyim sağlar.
...
SAP, Oracle ve Microsoft ürünleri gibi
...
AWS işlem hizmetleri için paylaşılan
...
sistemlerini başlatmayı, çalıştırmayı ve
...
sınıfları en yüksek performansı, veri
...
merkezden ve otomatik olarak korumanızı
...
ötesinde daha fazla özellik ve performans
...
Neredeyse sınırsız bulut depolama alanına
...
Boştaki kurtarma sitesi kaynaklarını
...
Amazon Corretto, Open Java Geliştirme
...
şekilde yönetmek için bir dizi
...
WS Cloud9, yalnızca bir tarayıcıyı
...
keşfetmeyi ve bunlarla etkileşim kurmayı
...
AWS CodeArtifact, her ölçekten kuruma,
...
kaynak kodunu derler, çeşitli testler
...
AWS CodeCommit, özel Git depoları
...
çalışan işlem hizmetlerine yazılım
...
AWS CodePipeline, hızlı ve güvenilir
...
AWS CodeStar, AWS\'de hızlı şekilde
...
çok AWS hizmetini komut satırından
...
durumunu ve esnekliğini iyileştirmeyi
...
hatalarını ayıklamasına yardımcı olur.
...
AWS Application Discovery Service, şirket
...
ve güvenli bir şekilde geçirmenize
...
Veri şifreleme ve veri bütünlüğü
...
Geleneksel ana bilgisayarların donanım ve
...
AWS ile yolculuğunuzu hızlandırmak ve
...
hızlandırır. Değişiklik olmadan ve
...
yönetin ve aktarım iş akışlarınızı
...
AWS Uygulama Geçişi Hizmeti (AWS MGN),
...
Kendi kendinize bir iş örneği oluşturmak
...
etmeyi, incelemeyi ve bunların temel
...
tehditleri hızlı bir biçimde açığa
...
Amazon Inspector, AWS üzerinde dağıtılmış
...
AWS Artifact, sizin için önemli olan
...
AWS Audit Manager, yönetmelikler ve
...
AWS CloudHSM, AWS Bulut\'ta kendi
...
Active Directory için AWS Directory
...
uygulamalarınız genelinde güvenlik duvarı
...
erişim denetimi sağlar. IAM ile kimlerin
...
uygulamalarınızda şifreleme anahtarları
...
AWS Ağ Güvenlik Duvarı, tüm Amazon Sanal
...
veri biçiminde otomatik olarak toplar.
...
AWS Shield, AWS üzerinde çalışan
...
oluşturduğunuz veya bağladığınız ve AWS
...
AWS WAF, web uygulamalarınızı veya
...
Tutarlı bir geliştirme araçları seti
...
Bazı makine öğrenimi uygulamaları hassas
...
CodeGuru\'yu mevcut yazılım geliştirme iş
...
Belgelerdeki metinlerden, müşteri destek
...
Amazon DevOps Guru, bir uygulamanın
...
Amazon Elastic Inference, derin öğrenme
...
operasyonları ölçeklendirir. Ayrıntılı
...
özelleştirilmiş bir dolandırıcılık
...
Sağlık verilerini dakikalar içinde
...
Amazon Kendra, makine öğrenimiyle (ML)
...
servisidir. Birçok dilde amacı anlayan,
...
Tahmine dayalı bakımın başarılı bir
...
belirleyen AWS servisidir. Amazon Lookout
...
Kalite denetimini otomatikleştirmek için
...
süresini azaltan AWS servisidir. Makine
...
sunduğu nöral metin seslendirme (NTTS)
...
servisidir. Sıfırdan makine öğrenimi (ML)
...
Tam olarak yönetilen altyapı, araçlar ve
...
Makine öğrenimi modellerinin eğitimi için
...
Basılı metni, el yazısını ve verileri
...
iş öngörülerini çıkarmanızı sağlar. Tam
...
Akıcı ve doğru makine çevirisi sağlayan
...
kullanımı kolay, sade bir API\'ye sahip
...
Derin öğrenme ortamlarını optimize
...
AWS DeepComposer, geliştiricilere makine
...
ile makine öğrenimini kelimenin tam
...
Beceri düzeyinden bağımsız olarak tüm
...
Uçta görüntü işleme operasyonlarınızı
...
Amazon Elastic Transcoder, bulutta medya
...
Etkileşim sağlayan canlı akış deneyimleri
...
Video işleme ve teslimi için şirket içi
...
Günümüzde yayıncılar ve içerik sahipleri,
...
Dağıtım veya arşivleme amacına yönelik
...
Herhangi bir cihaza yayın ve akış için
...
İnternet cihazlarına teslim edilmek üzere
...
Canlı akışlı medya iş akışları için video
...
işlevlerini tetiklemesini sağlayan bir
...
Dash Button donanımını temel alan
...
Cihazları buluta kolayca ve güvenli
...
cihaz filonuzun güvenliğini sağlamanıza
...
Birçok IoT dağıtımı yüz binlerce ila
...
IoT sensörlerinden ve uygulamalarından
...
Araç verilerini kolayca toplamanızı,
...
kaldırabileceğiniz önceden oluşturulmuş
...
uygulamalar oluşturan AWS servisidir.
...
eden AWS servisidir. Ek yazılım
...
IoT uygulamalarını göresel olarak
...
kurumsal uygulama verilerinizi, verileri
...
Bağlı bulut sunucuları ile çoklu oyuncu
...
Robotik simülasyonu çalıştırmanızı,
...
Uygulamalara ve kalıcı olmayan
...
olarak yazılım (SaaS) uygulamalarına
...
Kalıcı masaüstlerine her konumdan
...
denetleyebileceğiniz ve verileri
...
Üçüncü taraf uygulamaları ve AWS
...
AWS, mevcut sistemler veya SaaS
...
Apache Airflow için yüksek düzeyde
...
AWS tarafından sunulan tam olarak
...
uygulamadan uygulamaya (A2A) hem de
...
Mikro hizmetler, dağıtılmış sistemler ve
...
Functions, geliştiricilerin dağıtılmış
...
Tam MySQL ve PostgreSQL uyumluluğuyla
...
kolayca ölçeklendiren ve MongoDB ile
...
performansı, neredeyse sınırsız aktarım
...
ulaşan ve ölçeklendiren AWS servisidir.
...
Arka arkaya beş yıl boyunca Stack
...
çalıştırabilen AWS servisidir. Kimlik,
...
ölçeklendiren AWS servisidir. Altyapı
...
**3.20.9. Amazon Redshift**\
<img src = "../img/image21.png">
Uygun ölçekte hızlı, kolay ve güvenli
...
Amazon Timestream, IoT uygulamaları ve
...
AWS kaynaklarınızın ve uygulamalarınızın
...
Amazon Managed Grafana, Grafana Labs ile
...
Container\'larınız için yüksek oranda
...
Chatbot ile uyarılar alabilir, tanılama
...
bölgelerindeki kaynakları tek bir
...
günlüklerini kullanarak kuruluşunuzu
...
AWS kaynaklarınızın yapılandırmalarını
...
Birden fazla AWS hesabınız veya ekibiniz
...
AWS Başlatma Sihirbazı, Microsoft SQL
...
AWS License Manager, AWS ve şirket içi
...
hareket halindeyken vaka yanıtı desteği
...
yapılandırma yönetimi hizmetidir. Chef ve
...
AWS kaynaklarınızı ölçeklendirirken
...
AWS ortamınızı etkileyen önemli olayları
...
dağıtmasına yardımcı olmak için,
...
Dayanıklılık hedeflerini değerlendirir
...
AWS ürün kataloğunuzu oluşturmanıza,
...
AWS kaynakları ve şirket içi kaynaklara
...
Maliyetleri azaltan, performansı ve
...
Mimarinizi gözden geçiren ve en iyi
...
güvenli olmasını sağlayan AWS servisidir.
...
Amazon Pinpoint, esnek ve ölçeklenebilir
...
Genişletilebilir tam yığın web
...
Ölçeklenebilir GraphQL API'ler ile
...
AWS Device Farm, hiçbir test altyapısı
...
verim elde etmelerini sağlayan bir
...
Amazon Chime, tek bir uygulama kullanarak
...
yardım etmeye başlayabilmeleri için
...
ve iş birliği hizmetidir. Amazon WorkDocs
...
destekleyen, işletmelere yönelik güvenli
...
Değişen talebi karşılamak için işlem
...
Düşük maliyetli, önceden yapılandırılmış
...
eliştiriciler için geniş ölçekte üretim
...
AWS Auto Scaling, uygulamalarınızı izler
...
AWS Batch geliştiricilerin, bilim
...
Maliyetleri azaltmak ve iş yükleriniz
...
web uygulamalarını ve hizmetleri dağıtıp
...
Sunucuları veya kümeleri düşünmek zorunda
...
AWS Outposts, gerçekten tutarlı bir
...
5G cihazlar için ultra düşük gecikme
...
200'den fazla AWS hizmet yelpazesi ile
...
7:** Windows işletim sistemine sahip sanal makine*
...
3:** Kılavuz kapsamında oluşturulacak VPC*
...
|       | f1a0464a5c3/media/image283.png">
41644794in"}                            |
+-------+-------------------------------------------------------------+
...
> <img src = "../img/image296.png">
** AWS Fargate servisinin şeması*
...
> <img src = "../img/image299.png">
7:** AWS Snowball servisinin çalışma şeması*
